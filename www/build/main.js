...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"D:\Documents\Projects\tap-master\tap\src\pages\home\home.html"*/'<ion-content padding class="mycontent">\n\n\n\n\n\n  <div class="header" col-12>\n\n      SELECTED:\n\n\n\n      <span>\n\n          {{Ride.Car?.driver.user.firstName}} {{Ride.Car?.driver.user.lastName}}\n\n      </span>\n\n      <span> {{Ride.Car?.id}} </span>\n\n      <span *ngIf="Ride.Request">\n\n          <ion-icon name="arrow-dropright-circle"></ion-icon>\n\n           {{Ride.Request?.firstName}} {{Ride.Request?.lastName}} -\n\n          {{Ride.Request?.street}} {{Ride.Request?.street_num}}, {{Ride.Request?.city}}\n\n          <span class="sent" [hidden]="!confirmation"> sent </span>\n\n      </span>\n\n      <button (click)="cancelThis()" *ngIf="cancel">\n\n          Cancel\n\n      </button>\n\n      <span class="canceled" [hidden]="!canceled">Canceled </span>\n\n\n\n  </div>\n\n\n\n    <ion-row class="new_request">\n\n        <button ion-button (click)="requestModal()">new Request</button>\n\n    </ion-row>\n\n\n\n  <ion-row>\n\n    <div class="cars" col-6>\n\n        <button ion-button *ngFor="let car of homeCars" (click)="selectThis(\'car\',car)">\n\n            <div>{{car.driver.user.firstName}} {{car.driver.user.lastName}}</div>\n\n            <div>{{car.id}}</div>\n\n      </button>\n\n    </div>\n\n\n\n\n\n    <div class="requests" col-6>\n\n\n\n        <div class="row" *ngFor="let request of requests">\n\n            <span style="width: 5%"> {{request.street_num}} </span>\n\n            <span style="width: 20%"> {{request.street}} </span>\n\n            <span style="width: 15%"> {{request.city}} </span>\n\n            <!--span> {{request.country}} </span-->\n\n            <span style="width: 15%">{{request.zipcode}}</span>\n\n            <span style="width: 15%">{{request.baggage}} baggage </span>\n\n            <span style="width: 18%">{{request.notice}} </span>\n\n            <span style="width: 12%;text-align: right">\n\n                <ion-icon name="person" (click)="requestUserModal(request)"></ion-icon>\n\n                <ion-icon name="checkbox-outline" (click)="selectThis(\'request\',request)"></ion-icon>\n\n            </span>\n\n\n\n        </div>\n\n\n\n    </div>\n\n  </ion-row>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"D:\Documents\Projects\tap-master\tap\src\pages\home\home.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__providers_ride__["a" /* RideProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_ride__["a" /* RideProvider */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__providers_car__["a" /* CarProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__providers_car__["a" /* CarProvider */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__providers_request__["a" /* RequestProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__providers_request__["a" /* RequestProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* ModalController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* ModalController */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4__app_app_api__["a" /* AppApi */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__app_app_api__["a" /* AppApi */]) === "function" && _f || Object])
    ], HomePage);
    return HomePage;
